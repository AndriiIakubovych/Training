...
{
    public partial class EditGroupScheduleForm : Form
    {
        ...
        public EditGroupScheduleForm(DbConnection connection)
        {
            InitializeComponent();
        ...
        private void EditGroupScheduleForm_Load(object sender, EventArgs e)
        {
            try
            {
                int i = 0;
