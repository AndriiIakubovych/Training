namespace EducationalInstitution
{
    partial class AddGroupScheduleForm
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(AddGroupScheduleForm));
            ...
            this.subjectTypeChoice.Items.AddRange(new object[] {
            resources.GetString("subjectTypeChoice.Items"),
            resources.GetString("subjectTypeChoice.Items1"),
            resources.GetString("subjectTypeChoice.Items2")});
            ...
            this.dayChoice.Items.AddRange(new object[] {
            resources.GetString("dayChoice.Items"),
            resources.GetString("dayChoice.Items1"),
            resources.GetString("dayChoice.Items2"),
            resources.GetString("dayChoice.Items3"),
            resources.GetString("dayChoice.Items4"),
            resources.GetString("dayChoice.Items5"),
            resources.GetString("dayChoice.Items6")});
