...
SELECT Book_name FROM Books, Press, Themes WHERE Press_name LIKE 'BHV%' AND Theme_name LIKE '[Е-К]%' AND Books.Press_id = Press.Press_id AND Books.Theme_id = Themes.Theme_id;
